...
import { useAuctionStore, calcBidderRanking } from "@/features/bid/store/auctionStore";
import type { BidStatusByUser } from "@/features/bid/types/auction";
...
export function BidderRanking() {
  ...
  const topRanking = useMemo(() => calcBidderRanking(bidHistory).slice(0, 5), [bidHistory]);
